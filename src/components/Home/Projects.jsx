  ...
  return (
    <main className='m-4'>
        ...
        <article className='border-[1px] border-gray-200 w-[350px] v-[600] p-4 grid place-content-center'>
            ...
            <a href='https://ecomerce-academlo-ivan-jojoa.netlify.app/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md'>Go to Page</a>
            <a href='https://github.com/pinzaivan/ECOMERCE' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md' >Go to GitHub</a>
            </div>
            </section>              
        </article>
        ...
        <article className='border-[1px] border-gray-200 w-[350px] v-[600] p-4 grid place-content-center'>
            ...
            <div className='mt-4 flex justify-center gap-8'>
            <a href='https://entregable1-react-ivan-jojoa.netlify.app/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md'>Go to Page</a>
            <a href='https://github.com/pinzaivan/entregable1-react/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md' > Go to GitHub</a>
            </div>
            </section>            
        </article>
        ...
        <article className='border-[1px] border-gray-200 w-[350px] v-[600] p-4 grid place-content-center'>
            ...
            <div className='mt-4 flex justify-center gap-8'>
            <a href='https://entregable2-react-ivanjojoa.netlify.app/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md'>Go to Page</a>
            <a href='https://github.com/pinzaivan/entregable-2/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md' > Go to GitHub</a>
            </div>
            </section>            
        </article>
        ...
        <article className='border-[1px] border-gray-200 w-[350px] v-[600] p-4 grid place-content-center'>
            ...
            <div className='mt-4 flex justify-center gap-8'>
            <a href='https://entregable3ivanjojoa.netlify.app/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md'>Go to Page</a>
            <a href='https://github.com/pinzaivan/entregable3/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md' > Go to GitHub</a>
            </div>
            </section>              
        </article>
        ...
        <article className='border-[1px] border-gray-200 w-[350px] v-[600] p-4 grid place-content-center'>
            ...
            <div className='mt-4 flex justify-center gap-8'>
            <a href='https://entregable4ivanjojoa.netlify.app/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md'>Go to Page</a>
            <a href='https://github.com/pinzaivan/entregable4/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md' >Go to GitHub</a>
            </div>
            </section>              
        </article>
        ...
        <article className='border-[1px] border-gray-200 w-[350px] v-[600] p-4 grid place-content-center'>
            ...
            <div className='mt-4 flex justify-center gap-8'>
            <a href='https://entregable6ivanjojoa.netlify.app/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md'>Go to Page</a>
            <a href='https://github.com/pinzaivan/entregable6/' className=' w-[30%] border-[1px] border-yellow-500  hover:bg-yellow-500 hover:text-black transition-colors rounded-md' >Go to GitHub</a>
            </div>
            </section>              
        </article>
