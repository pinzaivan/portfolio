  ...
  return (
    <main>
      ...
      <section className='grid grid-cols-3'>
        <div className="h-[250px] w-[300px] border-t border-b border-dotted border-white p-3">
          <h2 className="pb-2 text-xl text-center">BANK</h2>
          <p className="pt-3 font-light">
          Es una aplicación de backend desarrollada en Node.js con SQL, que implementa operaciones CRUD utilizando peticiones GET, POST, PUT y DELETE. Permite la creación de usuarios con sus respectivas claves y la realización de transferencias de dinero entre cuenta.
          </p>
          <br></br>
